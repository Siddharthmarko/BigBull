...
function Login() {
  ...
  <div className="main-container flex flex-col items-center">
    ...
    <div className="parent-container w-full md:w-10/12 shadow-lg p-2 rounded-lg">
      <div className="child-container flex flex-col md:flex-row justify-between">
        {/* image */}
        <div className="box-image w-full md:w-5/12 flex justify-center items-center my-auto">
          {/* <img className='register-img' src={img} alt="" width="80%" /> */}
        </div>
        <div className="box w-full md:w-7/12">
                ...
                <div className="bottom-forgetaccount flex justify-between py-2">
                  ...
                  <div className="no-account">
                    <p className="text-gray-700">
                      ...
                      <a href="#" className="register-link underline px-1">
                        Register
                      </a>
                    </p>
                  </div>
